...
namespace Filemanager
{
    ...
    public class FilemanagerController : Controller
    {
        ...
        private string Translit(string filename)
        {
            string translit = "";
            foreach (var ch in filename)
            {
                if (_translit.ContainsKey(ch.ToString()))
                {
                    translit += _translit[ch.ToString()];
                }
                else
                {
                    translit += ch;
        ...
        public ActionResult Index(string mode, string path = "/uploads/")
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        baseFileName = Translit(baseFileName);
